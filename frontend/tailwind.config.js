...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        heading: ['BinanceNova', 'Inter', '-apple-system', 'BlinkMacSystemFont', 'sans-serif'],
        body: ['BinanceNova', 'Inter', '-apple-system', 'BlinkMacSystemFont', 'sans-serif'],
        mono: ['BinancePlex', '"IBM Plex Sans"', '"JetBrains Mono"', 'monospace'],
      },
      boxShadow: {
