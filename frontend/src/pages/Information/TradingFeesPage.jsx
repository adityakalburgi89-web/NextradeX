    ...
    <PageTransition>
      <div className="min-h-[calc(100vh-80px)] py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-foreground mb-8">Trading Fees</h1>
          <div className="space-y-6 text-muted">
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-4">Spot Trading Fees</h2>
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-transparent">
                    <th className="py-3 px-4 text-foreground font-semibold">Action</th>
                    <th className="py-3 px-4 text-foreground font-semibold">Fee Rate</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-transparent">
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-8">Futures Trading Fees</h2>
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-transparent">
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-8">Options Trading Fees</h2>
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-transparent">
