    ...
    <PageTransition>
      <div className="min-h-[calc(100vh-80px)] py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-white mb-8">Settlement Prices</h1>
          <div className="space-y-6 text-muted">
            ...
            <h2 className="text-2xl font-semibold text-white pt-4">How Settlement Prices are Calculated</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-white pt-4">Settlement Sources</h2>
            ...
            <h2 className="text-2xl font-semibold text-white pt-4">Update Frequency</h2>
            <p>
              Settlement prices are updated every 5 seconds during market hours. 
              Final settlement occurs at 08:00 UTC daily.
            </p>

            <h2 className="text-2xl font-semibold text-white pt-4">Dispute Resolution</h2>
            <p>
