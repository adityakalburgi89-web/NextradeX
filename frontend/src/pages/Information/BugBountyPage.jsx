      ...
      <div className="min-h-[calc(100vh-80px)] py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-muted">
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-4">Scope</h2>
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-4">Out of Scope</h2>
            <ul className="list-disc list-inside space-y-2">
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-4">Rewards</h2>
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-transparent">
                    <th className="py-3 px-4 text-foreground font-semibold">Severity</th>
                    <th className="py-3 px-4 text-foreground font-semibold">Reward (Virtual USD)</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-transparent">
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-4">How to Report</h2>
            <p>
