    ...
    <PageTransition>
      <div className="min-h-[calc(100vh-80px)] py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-foreground mb-8">User Guide</h1>
          <div className="space-y-6 text-muted">
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-4">Tips for Success</h2>
            <ul className="list-disc list-inside space-y-2">
