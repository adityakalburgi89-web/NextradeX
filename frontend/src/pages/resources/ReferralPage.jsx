    ...
    <PageTransition>
      <div className="min-h-[calc(100vh-80px)] py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-foreground mb-8">Referral Program</h1>
          <div className="space-y-6 text-muted">
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-4">How It Works</h2>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-transparent">
                    ...
                    <th className="py-3 px-4 text-foreground font-semibold">Reward</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-transparent">
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-4">Terms</h2>
