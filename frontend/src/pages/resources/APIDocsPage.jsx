    ...
    <PageTransition>
      <div className="min-h-[calc(100vh-80px)] py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-foreground mb-8">API Documentation</h1>
          <div className="space-y-6 text-muted">
            <p className="text-lg">
              Integrate NexTradeX into your own applications using our REST and WebSocket APIs.
            </p>

            <h2 className="text-2xl font-semibold text-foreground pt-4">Base URLs</h2>
            <div className="bg-background p-4 rounded-2xl font-mono text-sm">
              <p>REST API: https://api.nextradex.sim/v1</p>
              <p>WebSocket: wss://ws.nextradex.sim</p>
            </div>

            <h2 className="text-2xl font-semibold text-foreground pt-4">Authentication</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-4">Rate Limits</h2>
            <ul className="list-disc list-inside space-y-2">
              <li>REST API: 120 requests per minute</li>
              <li>WebSocket: 100 messages per second</li>
            </ul>

            <h2 className="text-2xl font-semibold text-foreground pt-4">Endpoints</h2>
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-transparent">
                    <th className="py-3 px-4 text-foreground font-semibold">Endpoint</th>
                    <th className="py-3 px-4 text-foreground font-semibold">Method</th>
                    <th className="py-3 px-4 text-foreground font-semibold">Description</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-transparent">
