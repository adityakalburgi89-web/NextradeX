      ...
      <div className="min-h-[calc(100vh-80px)] py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-muted">
            <h2 className="text-2xl font-semibold text-white pt-4">Acceptance of Terms</h2>
            <p>
              By accessing and using NexTradeX, you accept and agree to be bound by the terms and 
              provision of this agreement.
            </p>
            
            <h2 className="text-2xl font-semibold text-white pt-4">Educational Purpose</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-white pt-4">User Responsibilities</h2>
            ...
            <h2 className="text-2xl font-semibold text-white pt-4">Disclaimer</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-white pt-4">Limitation of Liability</h2>
            <p>
