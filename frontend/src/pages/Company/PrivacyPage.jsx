      ...
      <div className="min-h-[calc(100vh-80px)] py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-muted">
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-4">How We Use Information</h2>
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-4">Cookies</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-4">Changes to Policy</h2>
            <p>
