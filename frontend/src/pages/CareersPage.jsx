  ...
  return (
    <PageTransition>
      <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center px-4 py-12">
        ...
        >
          <h1 className="relative text-[8rem] md:text-[12rem] font-black leading-none text-foreground">
          ...
          <div className="mt-12">
            ...
            >
              ...
              <span className="text-sm font-medium border-b border-transparent group-hover:border-transparent transition-all">Go Home</span>
            </a>
          </div>
        </motion.div>
      </div>
