    ...
    <PageTransition>
      <div className="min-h-[calc(100vh-80px)] py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-foreground mb-8">Support Center</h1>
          <div className="space-y-6 text-muted">
            ...
            <h2 className="text-2xl font-semibold text-foreground pt-4">Common Issues</h2>
            <div className="space-y-4">
              <div className="bg-background p-4 rounded-2xl">
                <h3 className="text-foreground font-semibold mb-2">Can't log in?</h3>
                <p>Try resetting your password or contact support for account recovery assistance.</p>
              </div>
              <div className="bg-background p-4 rounded-2xl">
                <h3 className="text-foreground font-semibold mb-2">Virtual balance not updating?</h3>
                <p>Refresh the page or clear your browser cache. If the issue persists, contact support.</p>
              </div>
              <div className="bg-background p-4 rounded-2xl">
                <h3 className="text-foreground font-semibold mb-2">Order not executing?</h3>
                <p>Check your available balance and ensure the price is within acceptable range.</p>
              </div>
            </div>

            <h2 className="text-2xl font-semibold text-foreground pt-4">FAQ</h2>
            <details className="bg-background p-4 rounded-2xl cursor-pointer">
              <summary className="text-foreground font-semibold">Is this a real trading platform?</summary>
