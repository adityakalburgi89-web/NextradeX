    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden font-body">
      ...
      <nav className="relative z-50 flex items-center justify-between px-6 py-4 max-w-7xl mx-auto border-b border-white/5">
        <div className="flex items-center gap-2">
          ...
          <span className="font-heading font-bold text-xl tracking-tight">NexTrade<span className="text-primary">X</span></span>
        </div>

        <div className="hidden md:flex items-center gap-8 font-mono text-sm text-muted">
          <a href="#trade" className="hover:text-primary transition-colors">Trade</a>
        ...
        <div className="flex items-center gap-4">
          <Button variant="ghost" className="hidden sm:inline-flex font-mono">Log In</Button>
      ...
      <main className="relative z-10 w-full max-w-7xl mx-auto px-6">
        ...
        <section className="py-24 md:py-32 flex flex-col lg:flex-row items-center justify-between gap-16">
          ...
          <div className="flex-1 text-center lg:text-left relative z-20">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
              <Button size="lg" className="w-full sm:w-auto">Start Trading</Button>
              <Button size="lg" variant="outline" className="w-full sm:w-auto">View Analytics</Button>
            </div>
          </div>
          ...
          <div className="flex-1 relative w-full h-[400px] md:h-[500px] flex items-center justify-center animate-float">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="w-[300px] h-[300px] md:w-[400px] md:h-[400px] rounded-full border border-primary/20 animate-spin-slow absolute" style={{ borderStyle: 'dashed' }} />
            ...
            <Card variant="glass" className="absolute bottom-[15%] right-[5%] p-4 w-48 animate-bounce" style={{ animationDuration: '5s', animationDelay: '1s' }}>
              <div className="flex items-center gap-2">
        ...
        <section className="py-24 border-y border-white/5 relative bg-grid-pattern">
          ...
          <div className="max-w-2xl mx-auto">
            <Card variant="glass" className="w-full relative z-10 border-t border-l border-t-primary border-l-primary !rounded-none">
              <div className="absolute -top-1 -left-1 w-2 h-2 bg-primary" /> {/* Corner Accent */}
              <CardHeader>
                <CardTitle className="font-mono text-xl text-primary">>&nbsp;_INITIALIZE_TRADE</CardTitle>
                <CardDescription>Enter parameters for algorithmic execution.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div>
                  <label className="font-mono text-xs text-muted uppercase tracking-widest mb-2 block">Asset Pair</label>
                  <Input placeholder="e.g. BTC/USDC" />
                </div>
                <div>
                  <label className="font-mono text-xs text-muted uppercase tracking-widest mb-2 block">Leverage (x)</label>
                  <Input type="number" placeholder="10" />
                </div>
              </CardContent>
              <CardFooter>
                <Button className="w-full font-mono">EXECUTE_ORDER</Button>
              </CardFooter>
            </Card>
          </div>
