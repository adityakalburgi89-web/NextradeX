...
export default function Navbar({ theme, isLoggedIn, user, setSearchOpen, triggerLogoutConfirm }) {
  ...
  return (
    <header className="sticky top-4 z-50 w-full px-4 max-w-[1200px] mx-auto pointer-events-none flex justify-center">
      <div className="bg-[#141522] border border-white/10 rounded-full px-3.5 py-1.5 shadow-[0_8px_30px_rgb(0,0,0,0.18)] flex items-center justify-between pointer-events-auto backdrop-blur-xl w-full max-w-fit gap-4 sm:gap-6">
